...
\newcommand{\thesistitle}{Twitter as an alternative review site} % Your thesis title, this is used in the title and abstract
\newcommand{\degree}{MAI (Computer and Electronic Engineering)} % Your degree name, this is used in the title page and abstract
\newcommand{\typeofthesis}{Dissertation} % dissertation, Final Year Project, report, etc.
\newcommand{\authorname}{Sin\'ead Dickson} % Your name, this is used in the title page and PDF stuff
%% Comment out the next line if you don't want your ID to appear
\newcommand{\authorid}{14310749} % Your ID
...
\hypersetup{Sinéad Dickson\authorname} % Set the PDF's author to your name
