...
\caption{\label{fig:decisiontree} Decision Tree Classifier Example.}
\end{figure}
...
\caption{\label{fig:mlp} Multi Layer Perceptron Classifier with one hidden layer \cite{scikit-learn}.}
\end{figure}
